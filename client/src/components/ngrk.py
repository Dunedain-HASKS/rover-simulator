...
ngrok.set_auth_token("AUTH_TOKEN")      # Enter the registered Auth_Token
public_url = ngrok.connect("http://192.168.26.248:81")                       # tunnel to host:port instead of localhost
